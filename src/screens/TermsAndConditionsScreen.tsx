        ...
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <Text style={[styles.text, { color: colors.text }]}>
                    ...
                    {"\n\n"}
                    These terms and conditions apply to the McAi player app (hereby referred to as "Application") for mobile devices that was created by Mustak ahamed (hereby referred to as "Service Provider") as an Ad Supported service.
                    {"\n\n"}
                    ...
                    {"\n\n"}
                    These terms and conditions are effective as of 2026-02-26
                    {"\n\n"}
                    <Text style={styles.heading}>Contact Us</Text>
                    {"\n\n"}
                    If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at flixindia99@gmail.com.
                </Text>
            </ScrollView>
        </View>
    );
